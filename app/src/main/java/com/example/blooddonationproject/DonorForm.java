...
public class DonorForm extends AppCompatActivity {
    ...
    private void regUser(){
        ...
        if(TextUtils.isEmpty(name)){
            ...
            switch (id){
                case R.id.male: sex = "Male"; break;
                case R.id.female: sex = "Female"; break;
            }
            RequestQueue requestQueue = Volley.newRequestQueue(DonorForm.this);
            final String finalSex = sex;
             StringRequest stringRequest = new StringRequest(Request.Method.POST, Constant.DONOR_URL,
