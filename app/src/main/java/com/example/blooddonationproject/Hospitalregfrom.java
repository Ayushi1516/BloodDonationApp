...
public class Hospitalregfrom extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hospitalregfrom);
        setTitle("Hospital Registration Form");
        init();
    ...
    private void regUser(){
        ...
        if(TextUtils.isEmpty(name)){
            ...
            final RequestQueue requestQueue = Volley.newRequestQueue(Hospitalregfrom.this);
            final StringRequest stringRequest = new StringRequest(Request.Method.POST, Constant.HOSPITAL_URL,
